...
const MemoizedFormControlLabel = React.memo(({ children, ...props }) => (
  <FormControlLabel {...props}>{children}</FormControlLabel>
));
...
const Register = () => {
  ...
  /* ========================= State variables of Validation in form ========================== */
  ...
  const [showSuccessCard, setShowSuccessCard] = useState(false); // State for success card visibility
